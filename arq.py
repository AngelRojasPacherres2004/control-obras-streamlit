...
# =====================================================
# ⚠️ VALIDAR SESIÓN DESDE COOKIE (ÚNICA FUENTE DE VERDAD)
# =====================================================
...
usuarios_page   = st.Page("pages/usuarios.py", title="Usuarios")
materiales_page = st.Page("pages/materiales.py", title="Materiales")
obras_page      = st.Page("pages/obras.py", title="Obras")
avances_page    = st.Page("pages/avances_pasante.py", title="Parte Diario")
